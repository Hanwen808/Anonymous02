...
control MyIngress(inout headers hdr,
	...
	action ac_set_resubmit_tag_1() {
		hdr.myrecord.resubmit_tag = 1;
	}

	table tb_set_resubmit_tag1 {
		key = {
			meta.term1 : exact;
		}
		actions = {
			ac_set_resubmit_tag_1;
			NoAction;
		}
		size = 8;
		const default_action = NoAction;
		const entries = {
			0 : ac_set_resubmit_tag_1;
		}
	}
	...
	table tb_stage2_cnt1_update {
		...
		size = 1;
		const default_action = ac_stage2_cnt1_update;
	}
	...
	table tb_stage2_src1_write {
		...
		size = 1;
		const default_action = ac_stage2_src1_write;
	}
	...
	table tb_stage2_dst1_write {
		...
		size = 1;
		const default_action = ac_stage2_dst1_write;
	}
